!(function (e) {
    var t = {};
    document.getElementById("foodKey").value = (localStorage["food"]) ? String.fromCharCode(localStorage["food"]) : "Q"
    document.getElementById("spikeKey").value = (localStorage["spike"]) ? String.fromCharCode(localStorage["spike"]) : "V"
    document.getElementById("trapKey").value = (localStorage["trap"]) ? String.fromCharCode(localStorage["trap"]) : "F"
    document.getElementById("wallKey").value = (localStorage["wall"]) ? String.fromCharCode(localStorage["wall"]) : "C"
    document.getElementById("millKey").value = (localStorage["mill"]) ? String.fromCharCode(localStorage["mill"]) : "N"
    var keys = {
        food: localStorage["food"] || document.getElementById("foodKey").value.charCodeAt(0),
        spike: localStorage["spike"] || document.getElementById("spikeKey").value.charCodeAt(0),
        trap: localStorage["trap"] || document.getElementById("trapKey").value.charCodeAt(0),
        wall: localStorage["wall"] || document.getElementById("wallKey").value.charCodeAt(0),
        windmill: localStorage["mill"] || document.getElementById("millKey").value.charCodeAt(0)
    }
    document.getElementById("foodKey").addEventListener("keyup", function() {
        if (this.value) (keys.food = this.value.charCodeAt(0), window.keys = keys, localStorage["food"] = keys.spike)
    })
    document.getElementById("spikeKey").addEventListener("keyup", function() {
        if (this.value) (keys.spike = this.value.charCodeAt(0), window.keys = keys, localStorage["spike"] = keys.spike)
    })
    document.getElementById("trapKey").addEventListener("keyup", function() {
        if (this.value) (keys.trap = this.value.charCodeAt(0), window.keys = keys, localStorage["trap"] = keys.trap)
    })
    document.getElementById("wallKey").addEventListener("keyup", function() {
        if (this.value) (keys.wall = this.value.charCodeAt(0), window.keys = keys, localStorage["wall"] = keys.wall)
    })
    document.getElementById("millKey").addEventListener("keyup", function() {
        if (this.value) (keys.windmill = this.value.charCodeAt(0), window.keys = keys, localStorage["mill"] = keys.windmill)
    })
    window.keys = keys
    function n(i) {
        ...
        (t.write = function (e, t, n, i, r, s) {
            ...
            for (
                ...
                ((a = Math.floor(Math.log(t) / Math.LN2)),
                    ...
                    (t += a + u >= 1 ? f / c : f * Math.pow(2, 1 - u)) * c >= 2 && (a++, (c /= 2)),
                    a + u >= h ? ((o = 0), (a = h)) : a + u >= 1 ? ((o = (t * c - 1) * Math.pow(2, r)), (a += u)) : ((o = t * Math.pow(2, u - 1) * Math.pow(2, r)), (a = 0))); r >= 8; e[n + d] = 255 & o, d += p, o /= 256, r -= 8
            );
    ...
    function (e, t, n) {
        ...
        (function (e) {
            ...
            function m(e, t, n, i, r) {
                ...
                if ("number" == typeof t)
                    return (t &= 255), c.TYPED_ARRAY_SUPPORT && "function" == typeof Uint8Array.prototype.indexOf ? (r ? Uint8Array.prototype.indexOf.call(e, t, n) : Uint8Array.prototype.lastIndexOf.call(e, t, n)) : y(e, [t], n, i, r);
            ...
            c.TYPED_ARRAY_SUPPORT &&
                ...
                (c.prototype.compare = function (e, t, n, i, r) {
                    if (!c.isBuffer(e)) throw new TypeError("Argument must be a Buffer");
                    if ((void 0 === t && (t = 0), void 0 === n && (n = e ? e.length : 0), void 0 === i && (i = 0), void 0 === r && (r = this.length), t < 0 || n > e.length || i < 0 || r > this.length))
            ...
            (c.prototype.slice = function (e, t) {
                var n,
                    i = this.length;
                if (((e = ~~e) < 0 ? (e += i) < 0 && (e = 0) : e > i && (e = i), (t = void 0 === t ? i : ~~t) < 0 ? (t += i) < 0 && (t = 0) : t > i && (t = i), t < e && (t = e), c.TYPED_ARRAY_SUPPORT))
            ...
            (c.prototype.writeInt32LE = function (e, t, n) {
                return (
                    ...
                    c.TYPED_ARRAY_SUPPORT ? ((this[t] = 255 & e), (this[t + 1] = e >>> 8), (this[t + 2] = e >>> 16), (this[t + 3] = e >>> 24)) : j(this, e, t, !0),
                    t + 4
                );
            }),
            (c.prototype.writeInt32BE = function (e, t, n) {
                return (
                    ...
                    c.TYPED_ARRAY_SUPPORT ? ((this[t] = e >>> 24), (this[t + 1] = e >>> 16), (this[t + 2] = e >>> 8), (this[t + 3] = 255 & e)) : j(this, e, t, !1),
                    t + 4
                );
            }),
    ...
    function (e, t, n) {
        (function (t) {
            ...
            (e.exports.waveCount = 0),
            (e.exports.waveMax = 1.3),
            (e.exports.waveProcess = true),
            ...
            (e.exports.mapScale = 25714),
            (e.exports.waterBiomeTop = 12600),
            (e.exports.sandBiomeTop = 2400),
    ...
    function (e, t, n) {
        ...
        function w(e) {
            y.start(
                function (t, n, a) {
                    var ip = t.split(".")[0]
                    var c = (i ? "wss" : "ws") + "://" + window.location.hostname + "/" + ip;
                    r.connect(
                            c,
                            function (e) {
                                Bi(),
                                    ...
                                    ((ue.onclick = s.checkTrusted(function () {
                                        ...
                                        (function () {
                                            ...
                                            (Pe.onchange = s.checkTrusted(function (e) {
                                                (localStorage["particles"] = Pe.checked ? true : false);
                                            })),
                                            (Ge.onchange = s.checkTrusted(function (e) {
                                                (localStorage["grids"] = Ge.checked ? true : false);
                                            })),
                                            (Te.checked = A),
        ...
        CanvasRenderingContext2D.prototype.oldRotate = CanvasRenderingContext2D.prototype.rotate;
        (CanvasRenderingContext2D.prototype.rotate = function() {
                (arguments[0] >= Number.MAX_SAFE_INTEGER || (arguments[0] <= -Number.MAX_SAFE_INTEGER)) && (arguments[0] = 0);
                CanvasRenderingContext2D.prototype.oldRotate.apply(this, arguments)
            });
        var M,
            A,
            P,
            ...
            Pe = document.getElementById("showParticles"),
            Ge = document.getElementById("showGrids"),
        ...
        var at = document.getElementById("featuredYoutube"),
            ot = [{
                    name: "[XTZ] eXTaZz",
                    link: "https://www.youtube.com/channel/UCZYpsLMnMW4A8Yito7lQcrg"
                },
            ],
        ...
        function pt() {
            var e,
                ...
                n = "",
                i = 0,
                domain = new URL(window.location.href.split("?")[0]).hostname.split('.')
            ...
            (xe.innerHTML = n),
            "sandbox." + domain == location.hostname ? ((e = "Back to MooMoo"), (t = "//" + domain + "/")) : ((e = "Try the sandbox"), (t = "//sandbox." + domain + "/")),
                        ...
                        (this.update = function (e, t) {
                            this.active &&
                                ((this.scale += 0.05 * t),
                                    ...
                                    (this.active = !1) :
                                    ((e.globalAlpha = 1 - Math.max(0, this.scale / o.mapPingScale)), e.beginPath(), e.arc((this.x / o.mapScale) * Ne.width, (this.y / o.mapScale) * Ne.width, this.scale, 0, 2 * Math.PI), e.stroke()));
                        });
                    })()),
                    qt.push(Vt)),
                Vt.init(e, t);
        ...
        function en() {
            for (var e = "", t = 0; t < o.skinColors.length; ++t)
                e +=
                t == ae ?
                "<div class='skinColorItem activeSkin' style='background-color:" + o.skinColors[t] + "' onclick='selectSkinColor(" + t + ")'></div>" :
                "<div class='skinColorItem' style='background-color:" + o.skinColors[t] + "' onclick='selectSkinColor(" + t + ")'></div>";
            Je.innerHTML = e;
        }
        ...
        function rn() {
            on
                ...
                ((Qe.style.display = "none"), (Ye.style.display = "none"), (nn.style.display = "block"), tn.focus(), yn()),
                (tn.value = "");
        }
        function sn(e) {
                ...
                s.checkTrusted(function (e) {
                    ...
                    for (var t = 0; t < e.changedTouches.length; t++) {
                        ...
                        n.pageX < document.body.scrollWidth / 2 && -1 == re.id ?
                            ((re.id = n.identifier), (re.startX = re.currentX = n.pageX), (re.startY = re.currentY = n.pageY), bn()) :
                            n.pageX > document.body.scrollWidth / 2 && -1 == se.id && ((se.id = n.identifier), (se.startX = se.currentX = n.pageX), (se.startY = se.currentY = n.pageY), R.buildIndex < 0 && ((O = 1), vn()));
                    }
                }),
                !1
            ),
                ...
                s.checkTrusted(function (e) {
                    ...
                    27 == t ?
                        ...
                        (gn[t] ||
                            ((gn[t] = 1),
                                window.keys.food == t ?
                                Sn(R.items.includes(0) ? 0 : R.items.includes(1) ? 1 : 2) :
                                window.keys.spike == t ?
                                Sn(R.items.includes(6) ? 6 : R.items.includes(7) ? 7 : R.items.includes(8) ? 8 : 9) :
                                window.keys.trap == t ?
                                Sn(R.items.includes(15) ? 15 : 16) :
                                window.keys.wall == t ?
                                Sn(R.items.includes(3) ? 3 : R.items.includes(4) ? 4 : 5) :
                                window.keys.windmill == t ?
                                Sn(R.items.includes(10) ? 10 : R.items.includes(11) ? 11 : 12) :
                                69 == t ?
                                r.send("7", 1) :
                                71 == t ?
                                (Mt || (Mt = {}), (Mt.x = R.x), (Mt.y = R.y)) :
                                88 == t ?
                                ((R.lockDir = R.lockDir ? 0 : 1), r.send("7", 0)) :
                                null != R.weapons[t - 49] ?
                                Sn(R.weapons[t - 49], !0) :
        ...
        function bn() {
            ...
            (null == wn || null == e || Math.abs(e - wn) > 0.3) && (r.send("33", e), (wn = e));
        }
        function xn() {
            r.send("14", 1);
        }
        ...
        function Dn(e, t, n) {
            null != e && (R.XP = e),
                null != t && (R.maxXP = t),
                null != n && (R.age = n),
                n == o.maxAge ? ((ze.innerHTML = "MAX AGE"), (He.style.width = "100%")) : ((ze.innerHTML = "AGE " + R.age), (He.style.width = (R.XP / R.maxXP) * 100 + "%"));
        }
        function Ln(e) {
                    ...
                    s.generateElement({
                        ...
                        children: [
                            s.generateElement({
                                ...
                                text: t + ". " + (R && R.admin ? `\u3010${e[n]}\u3011` : "") + ("" != e[n + 1] ? e[n + 1] : "unknown")
                            }),
                            s.generateElement({
                                class: "leaderScore",
        ...
        function Fn(e, t, n, i) {
            ...
            var s = n - e,
                ...
                c = o > r ? o / r : 1;
            (s /= c), (a /= c), be.beginPath(), be.arc(e + s, t + a, 0.5 * r, 0, 2 * Math.PI, !1), be.closePath(), (be.fillStyle = "white"), be.fill(), be.restore();
        }
        function zn(e, t, n) {
            ...
            if (n.src) {
                ...
                a ||
                    (((a = new Image()).onload = function () {
                        ...
                        (Hn[s] = a));
                        if (n.src.includes("fball") || n.src.includes("wspout")) {
                            i.rotate(rotate);
                            rotate+=1
                ...
                ((r = _.x + _.xWiggle - t),
                    ...
                    ((be.globalAlpha = _.hideFromEnemy ? 0.6 : 1),
                        ...
                        ((i = ri(_)),
                            ...
                            _.blocker && ((be.strokeStyle = "#db6e6e"), (be.globalAlpha = 0.3), (be.lineWidth = 6), si(0, 0, _.blocker, be, !1, !0)),
                            be.restore()) :
                        ((i = ni(_)), be.drawImage(i, r - i.width / 2, s - i.height / 2))));
        ...
        function Xn(e, t, n) {
            ...
            for (var i = 0; i < W.length; ++i)
                (_ = W[i]).zIndex == n && (_.animate(P), _.visible && ((_.skinRot += 0.002 * P), (L = (_ == R ? pn() : _.dir) + _.dirPlus), be.save(), be.translate(_.x - e, _.y - t), be.rotate(L), Nn(_, be), be.restore()));
        }
        function Nn(e, t) {
            ...
            if (
                (e.tailIndex > 0 &&
                    ...
                    (ei(l.weapons[e.weaponIndex], o.weaponVariants[e.weaponVariant].src, e.scale, 0, t),
            ...
            si(0, 0, e.scale, t),
                ...
                (t.rotate(Math.PI / 2),
                    (function e(t, n, i, r) {
                        ...
                        Gn.isLoaded && n.drawImage(Gn, -a.scale / 2, -a.scale / 2, a.scale, a.scale), !i && a && a.topSprite && (n.save(), n.rotate(r.skinRot), e(t + "_top", n, a, r), n.restore());
        ...
        function ni(e) {
            ...
            if (!i) {
                ...
                if ((a.translate(r.width / 2, r.height / 2), a.rotate(s.randFloat(0, Math.PI)), (a.strokeStyle = it), (a.lineWidth = 5.5), 0 == e.type))
                    for (var c, l = 0; l < 2; ++l) ai(a, 7, (c = _.scale * (l ? 0.5 : 1)), 0.7 * c), (a.fillStyle = t ? (l ? "#fff" : "#e3f1f4") : l ? "#b4db62" : "#9ebf57"), a.fill(), l || a.stroke();
                else if (1 == e.type)
                    if (2 == t)(a.fillStyle = "#606060"), ai(a, 6, 0.3 * e.scale, 0.71 * e.scale), a.fill(), a.stroke(), (a.fillStyle = "#89a54c"), si(0, 0, 0.55 * e.scale, a), (a.fillStyle = "#a5c65b"), si(0, 0, 0.3 * e.scale, a, !0);
                    else {
                        var h;
                        !(function (e, t, n, i) {
                            var r,
                            ...
                            for (var c = 0; c < 6; c++)(r = s.randInt(n + 0.9, 1.2 * n)), e.quadraticCurveTo(Math.cos(a + o) * r, Math.sin(a + o) * r, Math.cos(a + 2 * o) * i, Math.sin(a + 2 * o) * i), (a += 2 * o);
                    ...
                    (2 != e.type && 3 != e.type) ||
                    ((a.fillStyle = 2 == e.type ? (2 == t ? "#938d77" : "#939393") : "#e0c655"),
        ...
        function ri(e, t) {
            ...
            if (!n || t) {
                ...
                if ((r.translate(i.width / 2, i.height / 2), r.rotate(t ? 0 : Math.PI / 2), (r.strokeStyle = it), (r.lineWidth = 5.5 * (t ? i.width / 81 : 1)), "apple" == e.name)) {
                    ...
                    var h, u;
                    for (r.fillStyle = "#f4f3ac", si(0, 0, e.scale, r), r.fillStyle = "#c3c28b", o = T / (h = 4), c = 0; c < h; ++c)
                    ...
                    ai(r, f, 1.1 * e.scale, 1.1 * e.scale), r.fill(), r.stroke(), (r.fillStyle = "castle wall" == e.name ? "#9da4aa" : "wood wall" == e.name ? "#c9b758" : "#bcbcbc"), ai(r, f, 0.65 * e.scale, 0.65 * e.scale), r.fill();
                    ...
                    (r.fillStyle = "#a5974c"), si(0, 0, e.scale, r), (r.fillStyle = "#c9b758"), ci(0, 0, 1.5 * e.scale, 29, 4, r), (r.fillStyle = "#a5974c"), si(0, 0, 0.5 * e.scale, r);
                else if ("mine" == e.name)(r.fillStyle = "#939393"), ai(r, 3, e.scale, e.scale), r.fill(), r.stroke(), (r.fillStyle = "#bcbcbc"), ai(r, 3, 0.55 * e.scale, 0.65 * e.scale), r.fill();
                else if ("sapling" == e.name)
                    for (c = 0; c < 2; ++c) ai(r, 7, (d = e.scale * (c ? 0.5 : 1)), 0.7 * d), (r.fillStyle = c ? "#b4db62" : "#9ebf57"), r.fill(), c || r.stroke();
                else if ("pit trap" == e.name)(r.fillStyle = "#a5974c"), ai(r, 3, 1.1 * e.scale, 1.1 * e.scale), r.fill(), r.stroke(), (r.fillStyle = it), ai(r, 3, 0.65 * e.scale, 0.65 * e.scale), r.fill();
                ...
                else if ("turret" == e.name)(r.fillStyle = "#a5974c"), si(0, 0, e.scale, r), r.fill(), r.stroke(), (r.fillStyle = "#939393"), oi(0, -25, 0.9 * e.scale, 50, r), si(0, 0, 0.6 * e.scale, r), r.fill(), r.stroke();
                    ...
                    "healing pad" == e.name ?
                    ((r.fillStyle = "#7e7f82"), oi(0, 0, 2 * e.scale, 2 * e.scale, r), r.fill(), r.stroke(), (r.fillStyle = "#db6e6e"), ci(0, 0, 0.65 * e.scale, 20, 4, r, !0)) :
                    "spawn pad" == e.name ?
                    ((r.fillStyle = "#7e7f82"), oi(0, 0, 2 * e.scale, 2 * e.scale, r), r.fill(), r.stroke(), (r.fillStyle = "#71aad6"), si(0, 0, 0.6 * e.scale, r)) :
                    "blocker" == e.name ?
                    ((r.fillStyle = "#7e7f82"), si(0, 0, e.scale, r), r.fill(), r.stroke(), r.rotate(Math.PI / 4), (r.fillStyle = "#db6e6e"), ci(0, 0, 0.65 * e.scale, 20, 4, r, !0)) :
                    "teleporter" == e.name && ((r.fillStyle = "#7e7f82"), si(0, 0, e.scale, r), r.fill(), r.stroke(), r.rotate(Math.PI / 4), (r.fillStyle = "#d76edb"), si(0, 0, 0.5 * e.scale, r, !0));
                (n = i), t || (ii[e.id] = n);
            }
            return n;
        }
        ...
        var mi = {};
        function yi(e, t) {
            if (Z.aiTypes[e.index].parts) {
                var s = 1.2 * e.scale * (e.spriteMlt || 1)
                var n = e.index,
                i = mi[n];

                let parts = Z.aiTypes[n].parts
                ...
                if (!i) {
                    ...
                    (r.src = ".././img/animals/" + parts.body + ".png"),
                    (i.body = r);
                    ...
                    (o.src = ".././img/animals/" + parts.wing1 + ".png"),
                    (i.wing1 = o);
                    ...
                    (p.src = ".././img/animals/" + parts.wing2 + ".png"),
                    (i.wing2 = p);

                    (mi[n] = i);
                }
                
                if (i.wing1.isLoaded && i.wing2.isLoaded && i.body.isLoaded) {
                    t.drawImage(i.wing1, -s + 15, -s - 40, 2 * s, 2 * s);
                    t.drawImage(i.wing2, -s - 15, -s - 40, 2 * s, 2 * s);
                    t.drawImage(i.body, -s, -s, 2 * s, 2 * s);
                }
            } else {
                var n = e.index,
                i = mi[n];
        ...
        function vi(e, t) {
            ...
            n || ((n = new u(e[0], e[1], o, s, J, nt, W, Y, l, et, tt)), W.push(n)),
                ...
                (n.y2 = void 0),
                n.setData(e),
                t && ((U = (R = n).x), (D = R.y), $t(), On(), Dn(), Un(0), (Be.style.display = "block"));
        }
        function wi(e) {
            for (var t = 0; t < W.length; t++)
                if (W[t].id == e) {
        ...
        (function e() {
            ...
            (q = B),
            (function () {
                if ((R && (!C || B - C >= 1e3 / o.clientSendRate) && ((C = B), r.send("2", pn())), An < 120 && ((An += 0.1 * P), (Ge.style.fontSize = Math.min(Math.round(An), 120) + "px")), R)) {
                    var e = s.getDistance(U, D, R.x, R.y),
                        t = s.getDirection(R.x, R.y, U, D),
                        n = Math.min(0.01 * e * P, e);
                    e > 0.05 ? ((U += n * Math.cos(t)), (D += n * Math.sin(t))) : ((U = R.x), (D = R.y));
                ...
                var f = U - oe / 2,
                    d = D - ce / 2,
                    waveSpeed = (o.waveMax*100+o.waveCount);

                    if (o.waveProcess == true && o.waveCount <= 50) {
                        o.waveCount += 0.1
                        if (o.waveCount >= 50) o.waveProcess = false;
                    } else {
                        o.waveProcess = false
                        o.waveCount -= 0.1;
                        if (o.waveCount <= 0) o.waveProcess = true;
                    }
                    
                    (be.fillStyle = "#f0d53c"), be.fillRect(0, 0, o.mapScale, o.mapScale), // Light background colors
                    
                    o.waterBiomeTop - d >= ce ?
                    ((be.fillStyle = "#036bfc"), be.globalAlpha = 0.75, be.fillRect(0, 0, oe, ce + waveSpeed)) :
                    o.waterBiomeTop - d >= 0 ? 
                    ((be.fillStyle = "#036bfc"), be.globalAlpha = 0.75, be.fillRect(0, 0, oe, o.waterBiomeTop - d + waveSpeed), (be.fillStyle = "#ffff75"), be.globalAlpha = 0.50, be.fillRect(0, o.waterBiomeTop - d, oe, ce - (o.waterBiomeTop - d))) :
                    o.waterBiomeTop + o.sandBiomeTop - d >= ce ?
                    ((be.fillStyle = "#ffff75"), be.globalAlpha = 0.50,  be.fillRect(0, 0, oe, ce)) :
                    o.waterBiomeTop + o.sandBiomeTop - d >= 0 ?
                    ((be.fillStyle = "#ffff75"), be.globalAlpha = 0.50, be.fillRect(0, 0, oe, o.waterBiomeTop+o.sandBiomeTop - d), be.globalAlpha = 0.75, (be.fillStyle = "#73ff73"), be.fillRect(0, o.waterBiomeTop + o.sandBiomeTop - d, oe, ce - (o.waterBiomeTop + o.sandBiomeTop - d))) :
                    o.mapScale - (o.waterBiomeTop+o.sandBiomeTop) - d > ce ?
                    ((be.fillStyle = "#73ff73"), be.globalAlpha = 0.75, be.fillRect(0, 0, oe, o.mapScale - (o.waterBiomeTop+o.sandBiomeTop) - d), be.fillRect(0, o.mapScale - (o.snowBiomeTop+o.sandBiomeTop+2400) - d, oe, ce - (o.mapScale - (o.snowBiomeTop+o.sandBiomeTop+1200) - d))) :
                    ((be.fillStyle = "#73ff73"), be.globalAlpha = 0.75,  be.fillRect(0, 0, oe, ce)),
                ...
                /*o.snowBiomeTop - d <= 0 && o.mapScale - o.snowBiomeTop - d >= ce ?
                    ...
                    o.snowBiomeTop - d >= 0 ?
                    ((be.fillStyle = "#fff"), be.fillRect(0, 0, oe, o.snowBiomeTop - d), (be.fillStyle = "#b6db66"), be.fillRect(0, o.snowBiomeTop - d, oe, ce - (o.snowBiomeTop - d))) :
                    ((be.fillStyle = "#b6db66"), be.fillRect(0, 0, oe, o.mapScale - o.snowBiomeTop - d), (be.fillStyle = "#dbc666"), be.fillRect(0, o.mapScale - o.snowBiomeTop - d, oe, ce - (o.mapScale - o.snowBiomeTop - d))),
                    In ||
                    ((ee += te * o.waveSpeed * P) >= o.waveMax ? ((ee = o.waveMax), (te = -1)) : ee <= 1 && (ee = te = 1),
                        (be.globalAlpha = 1),
                        (be.fillStyle = "#dbc666"),
                    ...
                    (be.globalAlpha = 0.06),
                    be.beginPath();
                if (localStorage["grids"] == true) for (var p = -U; p < oe; p += ce / 18) p > 0 && (be.moveTo(p, 0), be.lineTo(p, ce));
                if (localStorage["grids"] == true) for (var g = -D; g < ce; g += ce / 18) p > 0 && (be.moveTo(0, g), be.lineTo(oe, g));
                for (be.stroke(), be.globalAlpha = 1, be.strokeStyle = it, Yn(-1, f, d), be.globalAlpha = 1, be.lineWidth = 5.5, zn(0, f, d), Xn(f, d, 0), be.globalAlpha = 1, a = 0; a < Y.length; ++a)
                    (_ = Y[a]).active && _.visible && (_.animate(P), be.save(), be.translate(_.x - f, _.y - d), be.rotate(_.dir + _.dirPlus - Math.PI / 2), yi(_, be), be.restore());
                if ((Yn(0, f, d), zn(1, f, d), Yn(1, f, d), Xn(f, d, 1), Yn(2, f, d), Yn(3, f, d), (be.fillStyle = "#000"), (be.globalAlpha = 0.09), f <= 0 && be.fillRect(0, 0, -f, ce), o.mapScale - f <= oe)) {
                    var y = Math.max(0, -d);
                ...
                for (be.globalAlpha = 1, be.fillStyle = "rgba(0, 0, 70, 0.35)", be.fillRect(0, 0, oe, ce), be.strokeStyle = rt, a = 0; a < W.length + Y.length; ++a)
                    if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ == R || (_.team && _.team == R.team))) {
                        var w = (R && R.admin  ? `\u3010${_.sid}\u3011` : "") + (_.team ? "[" + _.team + "] " : "") + (_.name || "");
                        let maxHealth = _.isAI ? Z.aiTypes[_.index].health : 100,
                        scale = _.isAI ? Z.aiTypes[_.index].scale : 35
                        if ("" != w) {
                            if (
                                ((be.font = (_.nameScale || 30) + "px Hammersmith One"),
                                    ...
                                    (be.font = 20 + "px Hammersmith One"),
                                    be.strokeText(`Health: ${Math.round(_.health)}/${maxHealth}`, _.x - f, _.y - d + scale + 25),
                                    be.fillText(`Health: ${Math.round(_.health)}/${maxHealth}`, _.x - f, _.y - d + scale + 25),
                            ...
                            1 == _.iconIndex &&
                                Rn.skull.isLoaded &&
                                ((b = o.crownIconScale), (k = _.x - f - b / 2 + be.measureText(w).width / 2 + o.crownPad), be.drawImage(Rn.skull, k, _.y - d - _.scale - o.nameY - b / 2 - 5, b, b));
                        }

                        _.health > 0 &&
                            (o.healthBarWidth,
                                (o.healthBarWidth = _.skinIndex == 59 ? 65 : 50),
                                (_.maxHealth = _.skinIndex == 59 ? 130 : 100),
                                (be.fillStyle = rt),
                                ...
                                be.roundRect(_.x - f - o.healthBarWidth, _.y - d + _.scale + o.nameY + o.healthBarPad, 2 * o.healthBarWidth * (_.health / maxHealth), 17 - 2 * o.healthBarPad, 7),
                                be.fill());
                    }
                    ...
                    for (var h in s)
                        if (s.hasOwnProperty(h)) {
                            ...
                            for (a = i(t.fn, "function") ? t.fn() : t.fn, c = 0; c < e.length; c++)
                                1 === (l = e[c].split(".")).length ? (o[l[0]] = a) : (!o[l[0]] || o[l[0]] instanceof Boolean || (o[l[0]] = new Boolean(o[l[0]])), (o[l[0]][l[1]] = a)), r.push((a ? "" : "no-") + l.join("-"));
                        }
                })(),
                (function (e) {
                    var t = c.className,
    ...
    function (e, t, n) {
        ...
        (t.toByteArray = function (e) {
            ...
            return (
                2 === o && ((t = (r[e.charCodeAt(n)] << 2) | (r[e.charCodeAt(n + 1)] >> 4)), (c[h++] = 255 & t)),
                1 === o && ((t = (r[e.charCodeAt(n)] << 10) | (r[e.charCodeAt(n + 1)] << 4) | (r[e.charCodeAt(n + 2)] >> 2)), (c[h++] = (t >> 8) & 255), (c[h++] = 255 & t)),
                c
            );
        }),
    ...
    function (e, t) {
        ...
        (t.toString = function (e, t, n) {
            ...
            for (var r = "", s = 0; i < n;)
                ...
                (192 == (224 & s) ?
                    (s = ((31 & s) << 6) | (63 & this[i++])) :
                    224 == (240 & s) ?
                    (s = ((15 & s) << 12) | ((63 & this[i++]) << 6) | (63 & this[i++])) :
                    240 == (248 & s) && (s = ((7 & s) << 18) | ((63 & this[i++]) << 12) | ((63 & this[i++]) << 6) | (63 & this[i++])),
                    s >= 65536 ? ((s -= 65536), (r += String.fromCharCode(55296 + (s >>> 10), 56320 + (1023 & s)))) : (r += String.fromCharCode(s)));
            return r;
        }),
        (t.write = function (e, t) {
            for (var n = t || (t |= 0), i = e.length, r = 0, s = 0; s < i;)
                ...
                r < 55296 || r > 57343 ?
                ((this[n++] = 224 | (r >>> 12)), (this[n++] = 128 | ((r >>> 6) & 63)), (this[n++] = 128 | (63 & r))) :
                ((r = 65536 + (((r - 55296) << 10) | (e.charCodeAt(s++) - 56320))), (this[n++] = 240 | (r >>> 18)), (this[n++] = 128 | ((r >>> 12) & 63)), (this[n++] = 128 | ((r >>> 6) & 63)), (this[n++] = 128 | (63 & r)));
            return n - t;
        });
    },
    function (e, t, n) {
    ...
    function (e, t) {
                ...
                t.addEventListener(
                    ...
                    e.exports.checkTrusted(function (n) {
                        e.exports.mousifyTouchEvent(n),
                            ...
                            e.exports.containsPoint(t, n.pageX, n.pageY) ? r || (t.onmouseover && t.onmouseover(n), (r = !0)) : r && (t.onmouseout && t.onmouseout(n), (r = !1));
                    }),
                    !1
                ),
        ...
        (e.exports.generateElement = function (t) {
            ...
            if (
                (n.onclick && (n.onclick = e.exports.checkTrusted(n.onclick)),
    ...
    function (e, t) {
        (e.exports.AnimText = function () {
            (this.init = function (e, t, n, i, r, s, a) {
                (this.x = e), (this.y = t), (this.color = a), (this.scale = n), (this.startScale = this.scale), (this.maxScale = 1.5 * n), (this.scaleSpeed = 0.7), (this.speed = i), (this.life = r), (this.text = s);
            }),
            (this.update = function (e) {
                this.life &&
                    ((this.life -= e),
                        ...
                        this.scale >= this.maxScale ? ((this.scale = this.maxScale), (this.scaleSpeed *= -1)) : this.scale <= this.startScale && ((this.scale = this.startScale), (this.scaleSpeed = 0)),
        ...
        e.exports = function (e, t, o, c, l, h) {
            ...
            (this.setObjectGrids = function (e) {
                for (var t = Math.min(c.mapScale, Math.max(0, e.x)), n = Math.min(c.mapScale, Math.max(0, e.y)), i = 0; i < c.colGrid; ++i) {
                    ...
                    for (var r = 0; r < c.colGrid; ++r)
                        ...
                        n + e.scale >= f &&
                        n - e.scale <= f + d &&
                        (this.grids[i + "_" + r] || (this.grids[i + "_" + r] = []), this.grids[i + "_" + r].push(e), e.gridLocations.push(i + "_" + r));
                }
            }),
            ...
            (this.hitObj = function (e, t) {
                for (var n = 0; n < l.length; ++n)
                    l[n].active && (e.sentTo[l[n].id] && (e.active ? l[n].canSee(e) && h.send(l[n].id, "8", o.fixTo(t, 1), e.sid) : h.send(l[n].id, "12", e.sid)), e.active || e.owner != l[n] || l[n].changeItemCount(e.group.id, -1));
            });
            var p,
                g,
                m = [];
            (this.getGridArrays = function (e, t, i) {
                ...
                try {
                    this.grids[u + "_" + f] && m.push(this.grids[u + "_" + f]),
                        e + i >= (u + 1) * d &&
                        ((p = this.grids[u + 1 + "_" + f]) && m.push(p), f && t - i <= f * d ? (p = this.grids[u + 1 + "_" + (f - 1)]) && m.push(p) : t + i >= (f + 1) * d && (p = this.grids[u + 1 + "_" + (f + 1)]) && m.push(p)),
                        u &&
                        e - i <= u * d &&
                        ((p = this.grids[u - 1 + "_" + f]) && m.push(p), f && t - i <= f * d ? (p = this.grids[u - 1 + "_" + (f - 1)]) && m.push(p) : t + i >= (f + 1) * d && (p = this.grids[u - 1 + "_" + (f + 1)]) && m.push(p)),
                ...
                if (i(l) <= u || i(h) <= u) {
                    ...
                    if (f <= 0) {
                        if (t.ignoreCollision)
                            !t.trap || e.noTrap || t.owner == e || (t.owner && t.owner.team && t.owner.team == e.team) ?
                            t.boostSpeed ?
                            ((e.xVel += n * t.boostSpeed * (t.weightM || 1) * r(t.dir)), (e.yVel += n * t.boostSpeed * (t.weightM || 1) * s(t.dir))) :
                            t.healCol ?
                            (e.healCol = t.healCol) :
                            ...
                            if (
                                (o.getDistance(e.x, e.y, t.x, t.y),
                                    t.isPlayer ? ((f = (-1 * f) / 2), (e.x += f * r(d)), (e.y += f * s(d)), (t.x -= f * r(d)), (t.y -= f * s(d))) : ((e.x = t.x + u * r(d)), (e.y = t.y + u * s(d)), (e.xVel *= 0.75), (e.yVel *= 0.75)),
                                ...
                                (e.xVel += p * r(d)),
                                (e.yVel += p * s(d)),
                                !t.pDmg || (e.skin && e.skin.poisonRes) || ((e.dmgOverTime.dmg = t.pDmg), (e.dmgOverTime.time = 5), (e.dmgOverTime.doer = t.owner)),
                                    e.colDmg && t.health && (t.changeHealth(-e.colDmg) && this.disableObj(t), this.hitObj(t, o.getDirection(e.x, e.y, t.x, t.y)));
                            }
                        }
    ...
    function (e, t, n) {
        ...
        e.exports = function (e, t, n, l, h, u, f, d, p, g, m, y, k, v) {
            ...
            (this.spawn = function (e) {
                ...
                (this.targetDir = 0),
                (this.targetAngle = 0),
                (this.maxHealth = this.skinIndex == 59 ? 130 : 100),
            ...
            (this.resetResources = function (e) {
                for (var t = 0; t < n.resourceTypes.length; ++t) this[n.resourceTypes[t]] = 100000 // e ? 100 : 0
            }),
            ...
            (this.setUserData = function (e) {
                if (e) {
                    ...
                    var t = e.name + "",
                        r = !1,
                        s = (t = (t = (t = (t = t.slice(0, n.maxNameLength)).replace(/[^\w:\(\)\/? -]+/gim, " ")).replace(/[^\x00-\x7F]/g, " ")).trim())
                        .toLowerCase()
                        .replace(/\s/g, "")
                        .replace(/1/g, "i")
                        .replace(/0/g, "o")
                ...
                if (this.alive) {
                    if ((this.shameTimer > 0 && ((this.shameTimer -= e), this.shameTimer <= 0 && ((this.shameTimer = 0), (this.shameCount = 0))), (b -= e) <= 0)) {
                        ...
                        t && this.changeHealth(t, this),
                            this.dmgOverTime.dmg && (this.changeHealth(-this.dmgOverTime.dmg, this.dmgOverTime.doer), (this.dmgOverTime.time -= 1), this.dmgOverTime.time <= 0 && (this.dmgOverTime.dmg = 0)),
                            this.healCol && this.changeHealth(this.healCol, this),
                            (b = 1e3);
                    }
                    if (this.alive) {
                        if ((this.slowMult < 1 && ((this.slowMult += 8e-4 * e), this.slowMult > 1 && (this.slowMult = 1)), (this.noMovTimer += e), (this.xVel || this.yVel) && (this.noMovTimer = 0), this.lockMove))
                            (this.xVel = 0), (this.yVel = 0);
                        else {
                            var i =
                                (this.buildIndex >= 0 ? 0.5 : 1) *
                                (p.weapons[this.weaponIndex].spdMult || 1) *
                                ((this.skin && this.skin.spdMult) || 1) *
                                ((this.tail && this.tail.spdMult) || 1) *
                                (this.y <= n.snowBiomeTop ? (this.skin && this.skin.coldM ? 1 : n.snowSpeed) : 1) *
                                this.slowMult;
                            !this.zIndex &&
                                this.y >= n.mapScale / 2 - n.riverWidth / 2 &&
                                this.y <= n.mapScale / 2 + n.riverWidth / 2 &&
                                (this.skin && this.skin.watrImm ? ((i *= 0.75), (this.xVel += 0.4 * n.waterCurrent * e)) : ((i *= 0.33), (this.xVel += n.waterCurrent * e)));
                        ...
                        if (
                            (this.xVel && ((this.xVel *= o(n.playerDecel, e)), this.xVel <= 0.01 && this.xVel >= -0.01 && (this.xVel = 0)),
                                this.yVel && ((this.yVel *= o(n.playerDecel, e)), this.yVel <= 0.01 && this.yVel >= -0.01 && (this.yVel = 0)),
                            ...
                            if (null != p.weapons[this.weaponIndex].gather) this.gather(f);
                                ...
                                p.weapons[this.weaponIndex].rec && ((this.xVel -= p.weapons[this.weaponIndex].rec * s(this.dir)), (this.yVel -= p.weapons[this.weaponIndex].rec * a(this.dir))),
            ...
            (this.earnXP = function (e) {
                this.age < n.maxAge &&
                    ((this.XP += e),
                        this.XP >= this.maxXP ?
                        (this.age < n.maxAge ? (this.age++, (this.XP = 0), (this.maxXP *= 1.2)) : (this.XP = this.maxXP),
                            this.upgradePoints++,
            ...
            (this.changeHealth = function (e, t) {
                ...
                e < 0 && this.skin && (e *= this.skin.dmgMult || 1),
                    ...
                    (this.health += e),
                    this.health > this.maxHealth && ((e -= this.health - this.maxHealth), (this.health = this.maxHealth)),
            ...
            (this.kill = function (e) {
                e && e.alive && (e.kills++, e.skin && e.skin.goldSteal ? k(e, Math.round(this.points / 2)) : k(e, Math.round(100 * this.age * (e.skin && e.skin.kScrM ? e.skin.kScrM : 1))), y.send(e.id, "9", "kills", e.kills, 1)),
                    (this.alive = !1),
                    y.send(this.id, "11"),
                    v();
            }),
            ...
            (this.buildItem = function (e) {
                ...
                if (this.canBuild(e) && !(e.consume && this.skin && this.skin.noEat) && (e.consume || u.checkItemLocation(n, i, e.scale, 0.6, e.id, !1, this))) {
                    var r = !1;
                    if (e.consume) {
                        if (this.hitTime) {
            ...
            (this.gather = function () {
                (this.noMovTimer = 0), (this.slowMult -= p.weapons[this.weaponIndex].hitSlow || 0.3), this.slowMult < 0 && (this.slowMult = 0);
                for (var e, t, i, r = n.fetchVariant(this), o = r.poison, c = r.val, h = {}, g = u.getGridArrays(this.x, this.y, p.weapons[this.weaponIndex].range), m = 0; m < g.length; ++m)
                    for (var y = 0; y < g[m].length; ++y)
                        if (
                            ...
                            !t.dontGather &&
                            !h[t.sid] &&
                            t.visibleToPlayer(this) &&
                            l.getDistance(this.x, this.y, t.x, t.y) - t.scale <= p.weapons[this.weaponIndex].range &&
                            ((e = l.getDirection(t.x, t.y, this.x, this.y)), l.getAngleDist(e, this.dir) <= n.gatherAngle)
                        ) {
                ...
                for (y = 0; y < f.length + d.length; ++y)
                    if (
                        (t = f[y] || d[y - f.length]) != this &&
                        t.alive &&
                        (!t.team || t.team != this.team) &&
                        l.getDistance(this.x, this.y, t.x, t.y) - 1.8 * t.scale <= p.weapons[this.weaponIndex].range &&
                        ((e = l.getDirection(t.x, t.y, this.x, this.y)), l.getAngleDist(e, this.dir) <= n.gatherAngle)
                    ) {
                        ...
                        var x = p.weapons[this.weaponIndex].dmg * (this.skin && this.skin.dmgMultO ? this.skin.dmgMultO : 1) * (this.tail && this.tail.dmgMultO ? this.tail.dmgMultO : 1),
                            S = 0.3 * (t.weightM || 1) + (p.weapons[this.weaponIndex].knock || 0);
                        (t.xVel += S * s(e)),
                        (t.yVel += S * a(e)),
                        this.skin && this.skin.healD && this.changeHealth(x * b * this.skin.healD, this),
                            ...
                            !(t.dmgOverTime && this.skin && this.skin.poisonDmg) ||
                            (t.skin && t.skin.poisonRes) ||
                            ((t.dmgOverTime.dmg = this.skin.poisonDmg), (t.dmgOverTime.time = this.skin.poisonTime || 1), (t.dmgOverTime.doer = this)),
                            !t.dmgOverTime || !o || (t.skin && t.skin.poisonRes) || ((t.dmgOverTime.dmg = 5), (t.dmgOverTime.time = 5), (t.dmgOverTime.doer = this)),
                            t.skin && t.skin.dmgK && ((this.xVel -= t.skin.dmgK * s(e)), (this.yVel -= t.skin.dmgK * a(e))),
            ...
            (this.animate = function (e) {
                this.animTime > 0 &&
                    ((this.animTime -= e),
                        ...
                        0 == S ?
                        ((x += e / (this.animSpeed * n.hitReturnRatio)), (this.dirPlus = l.lerp(0, this.targetAngle, Math.min(1, x))), x >= 1 && ((x = 1), (S = 1))) :
                        ((x -= e / (this.animSpeed * (1 - n.hitReturnRatio))), (this.dirPlus = l.lerp(0, this.targetAngle, Math.max(0, x)))));
            }),
                    ...
                    if (
                        (this.skipMov ?
                            ...
                            ((this.x += u * Math.cos(this.dir)),
                                ...
                                (this.range -= u),
                                this.range <= 0 && ((this.x += this.range * Math.cos(this.dir)), (this.y += this.range * Math.sin(this.dir)), (u = 1), (this.range = 0), (this.active = !1))),
                            a)
                    ) {
                        for (var f = 0; f < e.length; ++f)
                            !this.sentTo[e[f].id] &&
                            e[f].canSee(this) &&
                            ((this.sentTo[e[f].id] = 1), a.send(e[f].id, "18", s.fixTo(this.x, 1), s.fixTo(this.y, 1), s.fixTo(this.dir, 2), s.fixTo(this.range, 1), this.speed, this.indx, this.layer, this.sid));
                        for (c.length = 0, f = 0; f < e.length + t.length; ++f)
                            !(o = e[f] || t[f - e.length]).alive ||
                            o == this.owner ||
                            (this.owner.team && o.team == this.owner.team) ||
                            (s.lineInRect(o.x - o.scale, o.y - o.scale, o.x + o.scale, o.y + o.scale, this.x, this.y, this.x + u * Math.cos(this.dir), this.y + u * Math.sin(this.dir)) && c.push(o));
                        ...
                        if (c.length > 0) {
                            ...
                            if (m.isPlayer || m.isAI) {
                                ...
                                for (m.projDmg && m.health && m.changeHealth(-this.dmg) && n.disableObj(m), f = 0; f < e.length; ++f)
                                    e[f].active &&
                                    (m.sentTo[e[f].id] && (m.active ? e[f].canSee(m) && a.send(e[f].id, "8", s.fixTo(this.dir, 2), m.sid) : a.send(e[f].id, "12", m.sid)),
            ...
            if (!this.connected) {
                ...
                null != i ?
                    (this.log("Connecting to server", i, "with game index", n),
                        ...
                        (window.history.replaceState(document.title, document.title, this.generateHref(e, t, n, this.password)),
                            (this.server = i),
                            (this.gameIndex = n),
    ...
    function (e, t, n) {
        ...
        (s.prototype.parse = function (e, t, n) {
            ...
            if (((v = v.trim()), !n && 1 === e.split("#").length)) {
                ...
                if (w)
                    return (
                        (this.path = v), (this.href = v), (this.pathname = w[1]), w[2] ? ((this.search = w[2]), (this.query = t ? k.parse(this.search.substr(1)) : this.search.substr(1))) : t && ((this.search = ""), (this.query = {})), this
                    );
            }
            var b = a.exec(v);
            if (b) {
            ...
            var Y = v.indexOf("?");
            if (
                (-1 !== Y ? ((this.search = v.substr(Y)), (this.query = v.substr(Y + 1)), t && (this.query = k.parse(this.query)), (v = v.slice(0, Y))) : t && ((this.search = ""), (this.query = {})),
                    v && (this.pathname = v),
        ...
        (s.prototype.resolveObject = function (e) {
            ...
            if (
                ...
                return (
                    T && ((n.hostname = n.host = S.shift()), (P = !!(n.host && n.host.indexOf("@") > 0) && n.host.split("@")) && ((n.auth = P.shift()), (n.host = n.hostname = P.shift()))),
                    (n.search = e.search),
                    (n.query = e.query),
            ...
            for (var I = S.slice(-1)[0], E = ((n.host || e.host || S.length > 1) && ("." === I || ".." === I)) || "" === I, M = 0, A = S.length; A >= 0; A--)
                "." === (I = S[A]) ? S.splice(A, 1) : ".." === I ? (S.splice(A, 1), M++) : M && (S.splice(A, 1), M--);
            if (!b && !x)
                for (; M--; M) S.unshift("..");
            ...
            return (
                T && ((n.hostname = n.host = B ? "" : S.length ? S.shift() : ""), (P = !!(n.host && n.host.indexOf("@") > 0) && n.host.split("@")) && ((n.auth = P.shift()), (n.host = n.hostname = P.shift()))),
            ...
            !(function (s) {
                ...
                function v(e) {
                    for (var t, n, i = [], r = 0, s = e.length; r < s;)
                        (t = e.charCodeAt(r++)) >= 55296 && t <= 56319 && r < s ? (56320 == (64512 & (n = e.charCodeAt(r++))) ? i.push(((1023 & t) << 10) + (1023 & n) + 65536) : (i.push(t), r--)) : i.push(t);
                    return i;
                }
                function w(e) {
                ...
                function T(e) {
                    ...
                    for (r = n > 0 ? n + 1 : 0; r < g;) {
                        for (s = y, a = 1, o = l; r >= g && m("invalid-input"), ((h = b(e.charCodeAt(r++))) >= l || h > p((c - y) / a)) && m("overflow"), (y += h * a), !(h < (u = o <= v ? 1 : o >= v + 26 ? 26 : o - v)); o += l)
                        ...
                        (h = y(
                            (h = y(
                                (h = y(
                                    (h = y(
                                        (h = m(
                                            (h = m(
                                                (h = m(
                                                    (h = m(
                                                        (h = g(
                                                            (h = g(
                                                                (h = g(
                                                                    (h = g(
                                                                        (h = p(
                                                                            (h = p(
                                                                                (h = p(
                                                                                    (h = p(
                                                                                        h,
                                                                                        (u = p(u, (f = p(f, (l = p(l, h, u, f, o[d + 0], 7, -680876936)), h, u, o[d + 1], 12, -389564586)), l, h, o[d + 2], 17, 606105819)),
                                                                                        f,
                                                                                        l,
                                                                                        o[d + 3],
                                                                                        22,
                                                                                    ...
                                                                                    (u = p(u, (f = p(f, (l = p(l, h, u, f, o[d + 4], 7, -176418897)), h, u, o[d + 5], 12, 1200080426)), l, h, o[d + 6], 17, -1473231341)),
                                                                                    f,
                                                                                    l,
                                                                                    o[d + 7],
                                                                                    22,
                                                                                ...
                                                                                (u = p(u, (f = p(f, (l = p(l, h, u, f, o[d + 8], 7, 1770035416)), h, u, o[d + 9], 12, -1958414417)), l, h, o[d + 10], 17, -42063)),
                                                                                f,
                                                                                l,
                                                                                o[d + 11],
                                                                                22,
                                                                            ...
                                                                            (u = p(u, (f = p(f, (l = p(l, h, u, f, o[d + 12], 7, 1804603682)), h, u, o[d + 13], 12, -40341101)), l, h, o[d + 14], 17, -1502002290)),
                                                                            f,
                                                                            l,
                                                                            o[d + 15],
                                                                            22,
                                                                        ...
                                                                        (u = g(u, (f = g(f, (l = g(l, h, u, f, o[d + 1], 5, -165796510)), h, u, o[d + 6], 9, -1069501632)), l, h, o[d + 11], 14, 643717713)),
                                                                        f,
                                                                        l,
                                                                        o[d + 0],
                                                                        20,
                                                                    ...
                                                                    (u = g(u, (f = g(f, (l = g(l, h, u, f, o[d + 5], 5, -701558691)), h, u, o[d + 10], 9, 38016083)), l, h, o[d + 15], 14, -660478335)),
                                                                    f,
                                                                    l,
                                                                    o[d + 4],
                                                                    20,
                                                                ...
                                                                (u = g(u, (f = g(f, (l = g(l, h, u, f, o[d + 9], 5, 568446438)), h, u, o[d + 14], 9, -1019803690)), l, h, o[d + 3], 14, -187363961)),
                                                                f,
                                                                l,
                                                                o[d + 8],
                                                                20,
                                                            ...
                                                            (u = g(u, (f = g(f, (l = g(l, h, u, f, o[d + 13], 5, -1444681467)), h, u, o[d + 2], 9, -51403784)), l, h, o[d + 7], 14, 1735328473)),
                                                            f,
                                                            l,
                                                            o[d + 12],
                                                            20,
                                                        ...
                                                        (u = m(u, (f = m(f, (l = m(l, h, u, f, o[d + 5], 4, -378558)), h, u, o[d + 8], 11, -2022574463)), l, h, o[d + 11], 16, 1839030562)),
                                                        f,
                                                        l,
                                                        o[d + 14],
                                                        23,
                                                    ...
                                                    (u = m(u, (f = m(f, (l = m(l, h, u, f, o[d + 1], 4, -1530992060)), h, u, o[d + 4], 11, 1272893353)), l, h, o[d + 7], 16, -155497632)),
                                                    f,
                                                    l,
                                                    o[d + 10],
                                                    23,
                                                ...
                                                (u = m(u, (f = m(f, (l = m(l, h, u, f, o[d + 13], 4, 681279174)), h, u, o[d + 0], 11, -358537222)), l, h, o[d + 3], 16, -722521979)),
                                                f,
                                                l,
                                                o[d + 6],
                                                23,
                                            ...
                                            (u = m(u, (f = m(f, (l = m(l, h, u, f, o[d + 9], 4, -640364487)), h, u, o[d + 12], 11, -421815835)), l, h, o[d + 15], 16, 530742520)),
                                            f,
                                            l,
                                            o[d + 2],
                                            23,
                                        ...
                                        (u = y(u, (f = y(f, (l = y(l, h, u, f, o[d + 0], 6, -198630844)), h, u, o[d + 7], 10, 1126891415)), l, h, o[d + 14], 15, -1416354905)),
                                        f,
                                        l,
                                        o[d + 5],
                                        21,
                                    ...
                                    (u = y(u, (f = y(f, (l = y(l, h, u, f, o[d + 12], 6, 1700485571)), h, u, o[d + 3], 10, -1894986606)), l, h, o[d + 10], 15, -1051523)),
                                    f,
                                    l,
                                    o[d + 1],
                                    21,
                                ...
                                (u = y(u, (f = y(f, (l = y(l, h, u, f, o[d + 8], 6, 1873313359)), h, u, o[d + 15], 10, -30611744)), l, h, o[d + 6], 15, -1560198380)),
                                f,
                                l,
                                o[d + 13],
                                21,
                            ...
                            (u = y(u, (f = y(f, (l = y(l, h, u, f, o[d + 4], 6, -145523070)), h, u, o[d + 11], 10, -1120210379)), l, h, o[d + 2], 15, 718787259)),
                            f,
                            l,
                            o[d + 9],
                            21,
    ...
    function (e, t) {
        e.exports = function (e, t, n, i, r, s, a, o, c) {
            (this.aiTypes = [{
                ...
                parts: {
                    body:"fdragon_1_body",
                    wing1:"fdragon_1_wing",
                    wing2:"fdragon_2_wing"
                },
                killScore:3e3,
                health:10e3,
                speed:0.35,
        ...
        e.exports = function (e, t, i, r, s, a, o, c) {
            ...
            (this.update = function (e) {
                if (this.active) {
                    ...
                    var r = !1,
                        o = 1;
                    if ((!this.zIndex && !this.lockMove && this.y >= a.mapScale / 2 - a.riverWidth / 2 && this.y <= a.mapScale / 2 + a.riverWidth / 2 && ((o = 0.33), (this.xVel += a.waterCurrent * e)), this.lockMove))
                        (this.xVel = 0), (this.yVel = 0);
                    else if (this.waitCount > 0) {
                        if (((this.waitCount -= e), this.waitCount <= 0))
                            if (this.chargePlayer) {
                                for (var h, u, f, d = 0; d < i.length; ++d)
                                    !i[d].alive || (i[d].skin && i[d].skin.bullRepel) || ((f = s.getDistance(this.x, this.y, i[d].x, i[d].y)) <= this.viewRange && (!h || f < u) && ((u = f), (h = i[d])));
                        ...
                        if (
                            (this.runFrom && this.runFrom.active && (!this.runFrom.isPlayer || this.runFrom.alive) ?
                                ((this.targetDir = s.getDirection(this.x, this.y, this.runFrom.x, this.runFrom.y)), (p *= 1.42)) :
                                this.chargeTarget && this.chargeTarget.alive && ((this.targetDir = s.getDirection(this.chargeTarget.x, this.chargeTarget.y, this.x, this.y)), (p *= 1.75), (r = !0)),
                                this.hitWait && (p *= 0.3),
                        ...
                        (this.moveCount -= e),
                        this.moveCount <= 0 && ((this.runFrom = null), (this.chargeTarget = null), (this.waitCount = this.hostile ? 1500 : s.randInt(1500, 6e3)));
                    }
                    ...
                    if (this.hitWait > 0 && ((this.hitWait -= e), this.hitWait <= 0)) {
                        ...
                        for (var M = t.getGridArrays(this.x, this.y, this.hitRange), A = 0; A < M.length; ++A)
                            for (b = 0; b < M[A].length; ++b)
                                (S = M[A][b]).health && (T = s.getDistance(this.x, this.y, S.x, S.y)) < S.scale + this.hitRange && (S.changeHealth(5 * -this.dmg) && t.disableObj(S), t.hitObj(S, s.getDirection(this.x, this.y, S.x, S.y)));
                    ...
                    if (r || E)
                        for (d = 0; d < i.length; ++d)
                            ...
                            ((T = s.getDistance(this.x, this.y, S.x, S.y)),
                                ...
                                T <= this.scale + S.scale && ((I = s.getDirection(S.x, S.y, this.x, this.y)), S.changeHealth(-this.dmg), (S.xVel += 0.55 * Math.cos(I)), (S.yVel += 0.55 * Math.sin(I))));
                    this.xVel && (this.xVel *= Math.pow(a.playerDecel, e)), this.yVel && (this.yVel *= Math.pow(a.playerDecel, e));
                    var P = this.scale;
                    this.x - P < 0 ? ((this.x = P), (this.xVel = 0)) : this.x + P > a.mapScale && ((this.x = a.mapScale - P), (this.xVel = 0)),
                        this.y - P < 0 ? ((this.y = P), (this.yVel = 0)) : this.y + P > a.mapScale && ((this.y = a.mapScale - P), (this.yVel = 0));
                }
            }),
            (this.canSee = function (e) {
                if (!e) return !1;
            ...
            (this.animate = function (e) {
                this.animTime > 0 &&
                    ((this.animTime -= e),
                        ...
                        0 == u ?
                        ((h += e / (this.animSpeed * a.hitReturnRatio)), (this.dirPlus = s.lerp(0, this.targetAngle, Math.min(1, h))), h >= 1 && ((h = 1), (u = 1))) :
                        ((h -= e / (this.animSpeed * (1 - a.hitReturnRatio))), (this.dirPlus = s.lerp(0, this.targetAngle, Math.max(0, h)))));
            }),
                ...
                if (
                    ...
                    ((this.health += e),
                        ...
                        (this.hitScare && !s.randInt(0, this.hitScare) ?
                            ((this.runFrom = n), (this.waitCount = 0), (this.moveCount = 2e3)) :
                            this.hostile && this.chargePlayer && n.isPlayer ?
                            ((this.chargeTarget = n), (this.waitCount = 0), (this.moveCount = 8e3)) :
                            this.dontRun || ((this.runFrom = n), (this.waitCount = 0), (this.moveCount = 2e3))),
                        ...
                        this.health <= 0 &&
                        (this.spawnDelay ? ((this.spawnCounter = this.spawnDelay), (this.x = -1e6), (this.y = -1e6)) : ((this.x = this.startX || s.randInt(0, a.mapScale)), (this.y = this.startY || s.randInt(0, a.mapScale))),
                            (this.health = this.maxHealth),
                            (this.runFrom = null),
